...
import { useGetActivitiesInstMutation } from 'src/redux/slices/institute/basicDetails';
...
export function NotificationsDrawer({ sx, ...other }) {
  ...
  const [getAllActivities, { data: activitiesData }] = useGetActivitiesInstMutation();
