...
import { useUpdateTypeDetailsOMSMutation } from 'src/redux/slices/common/applicationForm/typeDetails';
...
const Type = ({ data, updateRedux }) => {
  ...
  const [update, { isSuccess, isError, error, isLoading, data: updateSuccess }] =
    useUpdateTypeDetailsOMSMutation();
  ...
  return (
    <Box component="main" mt={2}>
      <Title2 title="Your Type of Candidature :" title2="OMS Candidate Type" />
