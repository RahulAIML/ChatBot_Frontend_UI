...
export const SignUpSchema = z.object({
	...
	userId: z
	  ...
	  .min(1, 'Please enter the valid User Id')
	  .max(8, 'Please enter the valid User Id '),
	password: z
	  .string()
...
export const loginValidate = z.object({
	...
	userId: z
		.string()
		.min(11, 'Please enter the valid User Id')
		.max(11, 'Please enter the valid User Id '),
});
	...
	export const resetPasswordVerfication = z.object({
		userId: z
		  .string()
		  .nonempty({ message: 'Please enter the User Id' })
		  .min(5, 'Please enter the valid User Id')
		  .max(11, 'Please enter the valid User Id'),
		mobile: z
		  .string()
